...
define(['player', 'entityfactory', 'lib/bison'], function(Player, EntityFactory, BISON) {
    ...
    var GameClient = Class.extend({
        init: function(host, port) {
            ...
            this.handlers[Types.Messages.TARGETHEALTH] =
                this.receiveTargetHealth;
        ...
        receiveTargetHealth: function(data) {
            var id = parseInt(data[1]),
                kind = data[2],
                hp = parseInt(data[3]),
                maxHp = parseInt(data[4]);

            if (this.targetHealthChange_callback) {
                this.targetHealthChange_callback(id, kind, hp, maxHp);
            }
        },
        ...
        onTargetChangeHealth: function(callback) {
            this.targetHealthChange_callback = callback;
        },
